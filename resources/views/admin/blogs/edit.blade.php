                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('blogs.update', $blog->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="content" class="form-control" rows="5">{{ old('content', $blog->body) }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($blog->featured_image)
                                        <div class="row">
                                            <div class="col-md-4">
                                                <img src="{{ asset($blog->featured_image) }}" alt="Featured Image" width="200" height="200" id="featured_image_preview" class="img-thumbnail">
                                            </div>
                                        </div>
                                    @endif
                                    <div class="row">
