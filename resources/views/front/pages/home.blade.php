			...
			<div class="col-lg-6">
				<div class="about-inner">
					<div class="section-title-box">
						...
						<p>Introducing JISYEEA: Our youth empowerment agency dedicated to providing skills, opportunities, and resources for meaningful employment. Join us in creating a supportive ecosystem, fostering partnership, effectiveness, efficiency, and innovation for the prosperous future of Jigawa State.</p>
					</div>
					<div class="row">
						<div class="col-xl-6 col-lg-12 col-md-6">
							<div class="about-card">
								<h4 class="about-title"><i class="fa-solid fa-circle-check"></i>Empowering Youth Through Skills Development</h4>
								<p class="about-text">JISYEEA offers comprehensive training programs that equip youth with the skills needed for successful careers, enabling them to thrive in today's competitive job market.</p>
							</div>
						</div>
						<div class="col-xl-6 col-lg-12 col-md-6">
							<div class="about-card">
								<h4 class="about-title"><i class="fa-solid fa-circle-check"></i>Fostering Partnerships for Success</h4>
								<p class="about-text">By collaborating with government agencies, industry partners, and educational institutions, JISYEEA creates a supportive ecosystem that amplifies youth empowerment and employment opportunities.</p>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-5">
				<div class="service-card">
					...
					<ul class="list-unstyled">
						...
						<li><a href="#">Skills Development Programs <i class="fa-solid fa-chevron-right"></i></a></li>
						<li><a href="#">Entrepreneurship Resources <i class="fa-solid fa-chevron-right"></i></a></li>
						<li><a href="#">Government Programs and Grants <i class="fa-solid fa-chevron-right"></i></a></li>
						<li><a href="#">Online Counseling Services <i class="fa-solid fa-chevron-right"></i></a></li>
						<li><a href="#">Youth Development Resources <i class="fa-solid fa-chevron-right"></i></a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-6">
				<div class="mayor-box">
					<div class="section-title-box">
						...
						<p>Dear Youth of Jigawa State,<br/>I am honored to serve as the Executive Secretary of JISYEEA. Together, let us embark on a journey of empowerment, innovation, and opportunity. Your skills, dreams, and potential are our priority as we work towards your success and a brighter future for Jigawa State.</p>
					</div>
	...
	<div class="container">
		...
		<div class="row row-gutter-y-155">
			<div class="col-lg-4">
				<div class="blog-card">
					<div class="blog-card-image">
						<img src="/theme/image/blog/blog-1.jpg" class="img-fluid" alt="img-22">
			...
			<div class="col-lg-4">
				<div class="blog-card">
					<div class="blog-card-image">
						<img src="/theme/image/blog/blog-2.jpg" class="img-fluid" alt="img-23">
						<a href="news-details.html"></a>
					</div>
					<div class="blog-card-date">
						<a href="news-details.html">28SEP</a>
			...
			<div class="col-lg-4">
				<div class="blog-card">
					<div class="blog-card-image">
						<img src="/theme/image/blog/blog-3.jpg" class="img-fluid" alt="img-24">
						<a href="news-details.html"></a>
					</div>
					<div class="blog-card-date">
						<a href="news-details.html">28SEP</a>
